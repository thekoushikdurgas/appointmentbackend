...
from app.utils.query_cache import QueryCache, get_query_cache, set_query_cache
...
async def lifespan(app: FastAPI):
    ...
    Note: Logging functionality has been removed.
    """
    ...
    if settings.ENABLE_PARALLEL_PROCESSING:
        try:
            ...
            # Failed to initialize thread pool (non-critical error)
            pass
    ...
    if settings.ENABLE_CACHE_WARMING and settings.ENABLE_QUERY_CACHING:
        try:
            ...
            # Cache warming failed (non-critical error)
            pass
    ...
    try:
        ...
        # Error shutting down thread pool (non-critical)
        pass
    ...
    try:
        ...
        # Could not get cache stats (non-critical)
        pass
