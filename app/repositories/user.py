...
class UserRepository(AsyncRepository[User]):
    ...
    async def get_by_uuid(self, session: AsyncSession, uuid: str) -> Optional[User]:
        ...
        Optimized query that uses idx_users_uuid_lookup_optimized index.
        """
        logger.debug("Getting user by UUID: uuid=%s", uuid)
        # Optimized: Uses index on uuid column
        # The index idx_users_uuid_lookup_optimized should be used for this query
