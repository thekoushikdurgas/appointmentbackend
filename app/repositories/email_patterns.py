...
class EmailPatternRepository(AsyncRepository[EmailPattern]):
    ...
    def __init__(self) -> None:
        ...
        logger.debug("Entering EmailPatternRepository.__init__")
        super().__init__(EmailPattern)
        logger.debug("Exiting EmailPatternRepository.__init__")
    ...
    async def get_by_company_uuid(
        ...
        logger.debug(
            "Entering EmailPatternRepository.get_by_company_uuid company_uuid=%s",
            company_uuid,
        )
        ...
        logger.debug(
            "Exiting EmailPatternRepository.get_by_company_uuid found=%d patterns",
            len(patterns),
        )
        return patterns
    ...
    async def get_by_pattern_format(
        ...
        logger.debug(
            "Entering EmailPatternRepository.get_by_pattern_format company_uuid=%s pattern_format=%s",
            company_uuid,
            pattern_format,
        )
        ...
        logger.debug(
            "Exiting EmailPatternRepository.get_by_pattern_format found=%s",
            pattern is not None,
        )
        return pattern
    ...
    async def increment_contact_count(
        ...
        """
        logger.debug(
            "Entering EmailPatternRepository.increment_contact_count pattern_uuid=%s increment=%d",
            pattern_uuid,
            increment,
        )
        ...
        if pattern:
            logger.debug(
                "Exiting EmailPatternRepository.increment_contact_count new_count=%d",
                pattern.contact_count,
            )
        else:
            logger.warning(
                "EmailPatternRepository.increment_contact_count pattern not found pattern_uuid=%s",
                pattern_uuid,
            )
        return pattern
    ...
    async def increment_contact_count_by_pattern_format(
        ...
        """
        logger.debug(
            "Entering EmailPatternRepository.increment_contact_count_by_pattern_format company_uuid=%s pattern_format=%s increment=%d",
            company_uuid,
            pattern_format,
            increment,
        )
        ...
        if pattern:
            logger.debug(
                "Exiting EmailPatternRepository.increment_contact_count_by_pattern_format new_count=%d",
                pattern.contact_count,
            )
        else:
            logger.warning(
                "EmailPatternRepository.increment_contact_count_by_pattern_format pattern not found company_uuid=%s pattern_format=%s",
                company_uuid,
                pattern_format,
            )
        return pattern
    ...
    async def decrement_contact_count(
        ...
        """
        logger.debug(
            "Entering EmailPatternRepository.decrement_contact_count pattern_uuid=%s decrement=%d",
            pattern_uuid,
            decrement,
        )
        ...
        if pattern:
            logger.debug(
                "Exiting EmailPatternRepository.decrement_contact_count new_count=%d",
                pattern.contact_count,
            )
        else:
            logger.warning(
                "EmailPatternRepository.decrement_contact_count pattern not found pattern_uuid=%s",
                pattern_uuid,
            )
        return pattern
    ...
    async def get_patterns_with_stats(
        ...
        logger.debug(
            "Entering EmailPatternRepository.get_patterns_with_stats company_uuid=%s",
            company_uuid,
        )
        patterns = await self.get_by_company_uuid(session, company_uuid)
        total_contacts = sum(p.contact_count or 0 for p in patterns)
        logger.debug(
            "Exiting EmailPatternRepository.get_patterns_with_stats patterns=%d total_contacts=%d",
            len(patterns),
            total_contacts,
        )
