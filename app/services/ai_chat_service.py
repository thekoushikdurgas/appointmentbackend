...
class AIChatService:
    ...
    async def send_message(
        ...
        try:
            ...
            logger.error("Failed to generate AI response: %s", exc, exc_info=True)
    ...
    async def send_message_stream(
        ...
        """
        logger.debug("Sending message (streaming): chat_id=%s user_id=%s", chat_id, user_id)
        ...
        try:
            ...
            logger.error("Failed to generate AI response (streaming): %s", exc, exc_info=True)
        ...
        logger.info("Message sent and AI response streamed: chat_uuid=%s", chat_id)
