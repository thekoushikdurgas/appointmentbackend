...
from app.core.constants import DEFAULT_ROLE, INITIAL_FREE_CREDITS
    ...
    async def register_user(
        ...
        if register_data.geolocation:
            try:
                ...
                # User history created for registration
            except Exception as exc:
                # History creation failed but registration continues (non-critical)
                pass
    ...
    async def upload_avatar(
                ...
                if self.s3_service.is_s3_key(profile.avatar_url):
                    ...
                    if old_avatar_path.exists():
                        try:
                            ...
                            pass  # Old avatar cleanup failed
            except Exception as exc:
                pass  # Old avatar cleanup failed
        ...
        if settings.S3_BUCKET_NAME:
            try:
                ...
                # Avatar uploaded to S3 successfully
            ...
            try:
                ...
                # Avatar saved to local storage successfully
