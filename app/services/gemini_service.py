...
class GeminiService:
    ...
    def _get_or_create_chat_session(
        ...
        try:
            ...
            logger.debug(f"Created new chat session for conversation: {conversation_id}")
            return chat
        except Exception as e:
    ...
    async def generate_chat_response(
        ...
        try:
            ...
            logger.error(f"Gemini API Error in chat: {e}", exc_info=True)
    ...
    async def generate_chat_response_stream(
        ...
        try:
            ...
            logger.error(f"Gemini API Error in streaming chat: {e}", exc_info=True)
    ...
    def clear_chat_session(self, conversation_id: str) -> None:
        ...
        if conversation_id in self._chat_sessions:
            ...
            logger.debug(f"Cleared chat session for conversation: {conversation_id}")

    def clear_all_sessions(self) -> None:
        """Clear all chat sessions."""
        self._chat_sessions.clear()
        logger.debug("Cleared all chat sessions")
