...
try:
    ...
    _user_cache: Optional[TTLCache] = TTLCache(maxsize=1000, ttl=300)  # Cache up to 1000 users for 5 minutes
...
async def get_current_user(
    ...
    # Get user from database (with caching optimization)
    user = None
    ...
    if not user:
        ...
        if user and CACHE_AVAILABLE and _user_cache is not None:
