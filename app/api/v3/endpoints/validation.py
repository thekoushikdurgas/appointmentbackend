...
async def validate_contact_single(
    ...
    """
    logger.info(
        "GET /v3/validation/contact/%s request received: user_id=%s",
        uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error validating contact: uuid=%s error=%s",
            uuid,
            str(e),
            exc_info=True,
        )
...
async def validate_contacts_batch(
    ...
    """
    logger.info(
        "POST /v3/validation/contact/batch/ request received: count=%d user_id=%s",
        len(request.uuids),
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error validating contacts batch: count=%d error=%s",
            len(request.uuids),
            str(e),
            exc_info=True,
        )
...
async def validate_company_single(
    ...
    """
    logger.info(
        "GET /v3/validation/company/%s request received: user_id=%s",
        uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error validating company: uuid=%s error=%s",
            uuid,
            str(e),
            exc_info=True,
        )
...
async def validate_companies_batch(
    ...
    """
    logger.info(
        "POST /v3/validation/company/batch/ request received: count=%d user_id=%s",
        len(request.uuids),
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error validating companies batch: count=%d error=%s",
            len(request.uuids),
            str(e),
            exc_info=True,
        )
