...
async def analyze_contact_single(
    ...
    """
    logger.info(
        "GET /v3/analysis/contact/%s request received: user_id=%s",
        uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error analyzing contact: uuid=%s error=%s",
            uuid,
            str(e),
            exc_info=True,
        )
...
async def analyze_contacts_batch(
    ...
    """
    logger.info(
        "POST /v3/analysis/contact/batch/ request received: count=%d user_id=%s",
        len(request.uuids),
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error analyzing contacts batch: count=%d error=%s",
            len(request.uuids),
            str(e),
            exc_info=True,
        )
...
async def analyze_company_single(
    ...
    """
    logger.info(
        "GET /v3/analysis/company/%s request received: user_id=%s",
        uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error analyzing company: uuid=%s error=%s",
            uuid,
            str(e),
            exc_info=True,
        )
...
async def analyze_companies_batch(
    ...
    """
    logger.info(
        "POST /v3/analysis/company/batch/ request received: count=%d user_id=%s",
        len(request.uuids),
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error analyzing companies batch: count=%d error=%s",
            len(request.uuids),
            str(e),
            exc_info=True,
        )
