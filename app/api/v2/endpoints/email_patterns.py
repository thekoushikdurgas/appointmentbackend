...
async def get_patterns_by_company(
    ...
    """
    logger.info(
        "GET /email-patterns/company/%s request received: user_id=%s",
        company_uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error getting patterns for company: company_uuid=%s error=%s",
            company_uuid,
            str(e),
            exc_info=True,
        )
...
async def create_pattern(
    ...
    """
    logger.info(
        "POST /email-patterns/ request received: company_uuid=%s pattern_format=%s upsert=%s user_id=%s",
    ...
    try:
        ...
        logger.error(
            "Error creating pattern: company_uuid=%s error=%s",
            pattern_data.company_uuid,
            str(e),
            exc_info=True,
        )
...
async def update_pattern(
    ...
    """
    logger.info(
        "PUT /email-patterns/%s request received: user_id=%s",
        pattern_uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error updating pattern: pattern_uuid=%s error=%s",
            pattern_uuid,
            str(e),
            exc_info=True,
        )
...
async def delete_pattern(
    ...
    """
    logger.info(
        "DELETE /email-patterns/%s request received: user_id=%s",
        pattern_uuid,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error deleting pattern: pattern_uuid=%s error=%s",
            pattern_uuid,
            str(e),
            exc_info=True,
        )
...
async def analyze_company_emails(
    ...
    """
    logger.info(
        "POST /email-patterns/analyze/%s request received: force_reanalyze=%s user_id=%s",
        company_uuid,
    ...
    try:
        ...
        logger.error(
            "Error analyzing company emails: company_uuid=%s error=%s",
            company_uuid,
            str(e),
            exc_info=True,
        )
...
async def import_patterns_from_csv(
    ...
    **Format 2: Contact Data Format (Pattern Extraction)**
    ...
    """
    logger.info(
        "POST /email-patterns/import request received: filename=%s user_id=%s",
        file.filename,
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error importing patterns from CSV: filename=%s error=%s",
            file.filename,
            str(e),
            exc_info=True,
        )
...
async def import_patterns_bulk(
    ...
    """
    logger.info(
        "POST /email-patterns/bulk request received: patterns_count=%d user_id=%s",
        len(bulk_data.patterns),
        current_user.uuid,
    )
    ...
    try:
        ...
        logger.error(
            "Error importing patterns in bulk: error=%s",
            str(e),
            exc_info=True,
        )
        raise HTTPException(
